...
(function() {
  ...
  describe('Authorization', function() {
    beforeEach(function() {
      window.fakeGetJSON = function(response) {
        return spyOn(jQuery, 'getJSON').andCallFake(function(url, callback) {
          callback(response);
          return {
            error: function(x) {}
          };
      ...
      return window.wordnik = new SwaggerApi({
        discoveryUrl: 'http://w00t'
      });
    });
    it('must not be present in the resources level', function() {
      var globalAuthorize;
      globalAuthorize = {
        authorization: {
          type: 'oauth2',
      ...
      return runs(function() {
        ...
        return expect(wordnik.resources.book.operations.book.authorization).toBeDefined();
      });
    });
    it('must not be present in the apis level', function() {
      var apiAuthorize;
      apiAuthorize = {
        nickname: 'getBook',
        apis: [
      ...
      return runs(function() {
        ...
        return expect(wordnik.resources.book.operations.book.authorization).not.toBeDefined();
      });
    });
    it('must not be present in the operations level', function() {
      var operationAuthorize;
      operationAuthorize = {
        nickname: 'getBook',
        apis: [
          {
    ...
    it('does inherit top level', function() {
      var authorizeInheritance;
      ...
      return runs(function() {
        ...
        return expect(wordnik.resources.book.operations.book.authorization).toEqual({
          type: 'oauth2',
          authorizeEndpoint: '/authorize',
          scope: 'ALL'
        });
    ...
    return it('must not be present if not in the root element', function() {
      var noAuthorize;
      noAuthorize = {
        apis: [
          {
      ...
      return runs(function() {
        expect(jQuery.getJSON).toHaveBeenCalled();
        return expect(wordnik.authorization).not.toBeDefined();
      });
    });
  });
