  ...
  describe('Authorization', function() {
    ...
    it('must not be present in the resources level', function() {
      ...
      return runs(function() {
        ...
        return expect(wordnik.apis.book.operations.book.authorization).toBeDefined();
      });
    });
    it('must not be present in the apis level', function() {
      ...
      return runs(function() {
        ...
        return expect(wordnik.apis.book.operations.book.authorization).not.toBeDefined();
      });
    });
    ...
    it('does inherit top level', function() {
      ...
      return runs(function() {
        ...
        return expect(wordnik.apis.book.operations.book.authorization).toEqual({
          type: 'oauth2',
          authorizeEndpoint: '/authorize',
          scope: 'ALL'
        });
