...
(function() {
  ...
  describe('Authorization', function() {
    ...
    it('must be present in the operations level', function() {
    ...
    it('does not inherit from all the levels', function() {
      ...
      return runs(function() {
        ...
        return expect(wordnik.resources.book.operations.book.authorization).not.toEqual({
          type: 'oauth2',
          authorizeEndpoint: '/authorize2',
          scope: 'SOME'
        });
    ...
    return it('must not be present if not in resources, apis or operations', function() {
      var noAuthorize;
      noAuthorize = {
        apis: [
          {
