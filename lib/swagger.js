...
(function() {
    ...
    SwaggerApi.prototype.build = function() {
      ...
      return jQuery.getJSON(this.discoveryUrl, function(response) {
        ...
        if (response.authorization != null) {
          _this.authorization = response.authorization;
        }
  ...
  SwaggerResource = (function() {
    ...
    function SwaggerResource(resourceObj, api) {
      var key, parts, value, _ref, _ref1, _ref2,
        _this = this;
      this.api = api;
      ...
      this.modelsArray = [];
      this.models = {};
      if (this.api.authorization != null) {
        this.authorization = {};
        _ref = this.api.authorization;
        for (key in _ref) {
          value = _ref[key];
          this.authorization[key] = value;
        }
      }
      if (resourceObj.authorization != null) {
        if ((_ref1 = this.authorization) == null) {
          this.authorization = {};
        }
        _ref2 = resourceObj.authorization;
        for (key in _ref2) {
          value = _ref2[key];
          this.authorization[key] = value;
        }
    ...
    SwaggerResource.prototype.addOperations = function(resource_path, ops) {
      ...
      if (ops) {
        ...
        for (_i = 0, _len = ops.length; _i < _len; _i++) {
          o = ops[_i];
          op = new SwaggerOperation(o.nickname, resource_path, o.httpMethod, o.parameters, o.summary, o.notes, o.responseClass, o.errorResponses, this, o.supportedContentTypes, o.authorization);
  ...
  SwaggerOperation = (function() {
    ...
    function SwaggerOperation(nickname, path, httpMethod, parameters, summary, notes, responseClass, errorResponses, resource, supportedContentTypes, authorization) {
      var key, parameter, v, value, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4,
        _this = this;
      ...
      if (this.resource.authorization != null) {
        if ((_ref3 = this.authorization) == null) {
          this.authorization = {};
        }
        _ref4 = this.resource.authorization;
        for (key in _ref4) {
          value = _ref4[key];
          if (!(this.authorization[key] != null)) {
            this.authorization[key] = value;
          }
        }
      }
